...
START_TEST(test_capture_generate_replay_command) {
  ...
  ck_assert_str_eq(eth0_up, "tcpdump -r eth0.pcap -w- 'dst net 10.0.0.1/24 or 10.5.1.5/24' | tcpreplay --topspeed -ieth0 -");
  ck_assert_str_eq(eth1_up, "tcpdump -r eth1.pcap -w- 'dst net 10.0.5.9/24' | tcpreplay --topspeed -ieth1 -");
